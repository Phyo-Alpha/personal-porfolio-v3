...
const ProjectCardSpaceCardDesignWrapper = ({
  children,
}: {
  ...
  <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-4 h-full">
    ...
    >
      ...
      >
        <div
          className={cn(
            "absolute inset-0 h-fit  rounded-lg overflow-hidden",
            isMobile ? "bg-white" : "bg-[#62EBCF]/10"
          )}
        >
          <img
            src={image}
...
export const ProjectCard = ({ ...props }: ProjectCardProps) => {
  ...
  if (isMobile) {
    return <ProjectCardContent isMobile={true} {...props} />;
  }

  return (
    <ProjectCardSpaceCardDesignWrapper>
      <ProjectCardContent isMobile={false} {...props} />
    </ProjectCardSpaceCardDesignWrapper>
  );
};
...
export const MiniProjectCard = ({
  ...
  return (
    <motion.div
      ...
      className="from-[#082628] to-[#081315] bg-gradient-to-r clip-path-angled size-85 md:size-96 z-1 p-10 space-y-6"
    >
