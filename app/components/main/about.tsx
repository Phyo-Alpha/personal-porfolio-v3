...
const MobileTabs = ({
  ...
  const currentIndex = aboutMe.findIndex(
  ...
  return (
    <div className="relative flex items-center justify-between min-h-20">
      ...
      <div ref={tabsRef} className="flex-1 overflow-hidden">
        <div className="flex transition-transform duration-300">
          {aboutMe.map((item) => (
            <div key={item.sectionName} className="w-full flex-shrink-0 px-4">
              <MobileTabButton
